const navbar = () => {
    return `<header class="bg-light shadow-sm">
        <nav class="navbar navbar-expand-lg navbar-light container">
            <a class="navbar-brand fw-bold" href="./Index.html">Closetique</a>
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="./Pages/ProductsPage.html">Shop</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="./Pages/ProductsPage.html">Categories</a>
                    </li>
                </ul>
